...
const PuzzleSchema = new mongoose.Schema({
  ...
  customerIdentityRedacted: { type: Boolean, default: false, index: true },
  customerIdentityRedactedAt: { type: Date, default: null },
  customerIdentityRedactionReason: { type: String, default: '' },
