export const studioCopy = {
  en: {
    ...
    sending: { headline: 'Going out now.', caption: 'of {{total}} invitations handed over', note: 'You can close this. We will keep sending.', continueLabel: 'Continue to Review' },
    home: {
      eyebrow: 'Your workspace', title: 'Your campaigns', create: 'Create campaign', search: 'Search campaigns',
      tabs: { All: 'All', Draft: 'Draft', Sending: 'Sending', Live: 'Live', Completed: 'Completed' },
      ...
      status: { draft: 'Draft', sending: 'Sending', active: 'Live', completed: 'Completed' },
      action: { draft: 'Resume', sending: 'View progress', active: 'View results', completed: 'View results' },
      deleteDraft: 'Delete draft', deleteConfirm: 'Delete this draft campaign? This cannot be undone.',
      recipientsCount: 'recipients', pieceSuffix: 'piece puzzle',
      updated: { editedAgo: 'Edited {{time}} ago', launchedAgo: 'Launched {{time}} ago', repliesClose: 'Replies close {{date}}', ended: 'Ended {{date}}' },
      context: { draft: '{{event}}{{sep}}{{puzzle}}', sending: 'Sending now · {{sent}} of {{total}} delivered', active: '{{going}} going · {{waiting}} waiting to reply', completed: '{{solved}} solved · {{going}} confirmed' },
  ...
  ar: {
    ...
    delivery: { title: 'اختر كيف تصل الأحجية.', body: 'JIGZO يرسل كل دعوة. يصل كل ضيف بالطريقة التي أدرجتها له.', readyLabel: 'دعوة جاهزة للإرسال', email: 'البريد الإلكتروني', emailStatus: 'يُرسل الآن', emailCaption: 'ضيف يصلهم عبر البريد', whatsapp: 'واتساب', whatsappCaption: 'ضيف بانتظار واتساب', whatsappCaptionMoved: 'تم النقل إلى البريد', whatsappPillBlocked: 'غير متاح بعد', whatsappPillMoved: 'تم النقل إلى البريد', blockedTitle: 'ضيف لا يمكن الوصول إليهم عبر واتساب بعد', blockedBody: 'التوصيل عبر واتساب بانتظار اعتماد Meta لقالب أعمالنا. كل شيء آخر في هذه الحملة جاهز. أصلح بيانات هؤلاء الضيوف في المستلمين، أو اتركهم وأرسل البقية.', seeWho: 'من هم', fixInRecipients: 'إصلاح في المستلمين', testTitle: 'أرسل نسخة لنفسك', testBody: 'دعوة حقيقية بأحجية حقيقية، موجهة إليك. لا تؤثر على نتائج أحد.', testPlaceholder: 'you@company.com', testButton: 'إرسال اختبار' },
    ...
    sending: { headline: 'جارٍ الإرسال الآن.', caption: 'من أصل {{total}} دعوة تم تسليمها', note: 'يمكنك إغلاق هذه الصفحة. سنواصل الإرسال.', continueLabel: 'متابعة إلى المراجعة' },
    home: {
      eyebrow: 'مساحة عملك', title: 'حملاتك', create: 'إنشاء حملة', search: 'ابحث في الحملات',
      tabs: { All: 'الكل', Draft: 'مسودة', Sending: 'قيد الإرسال', Live: 'مباشرة', Completed: 'مكتملة' },
      ...
      status: { draft: 'مسودة', sending: 'قيد الإرسال', active: 'مباشرة', completed: 'مكتملة' },
      action: { draft: 'استئناف', sending: 'عرض التقدم', active: 'عرض النتائج', completed: 'عرض النتائج' },
      deleteDraft: 'حذف المسودة', deleteConfirm: 'حذف هذه المسودة؟ لا يمكن التراجع عن هذا الإجراء.',
      recipientsCount: 'مستلم', pieceSuffix: 'أحجية قطعة',
      ...
      context: { draft: '{{event}}{{sep}}{{puzzle}}', sending: 'قيد الإرسال الآن · {{sent}} من {{total}} تم تسليمها', active: '{{going}} سيحضرون · {{waiting}} بانتظار الرد', completed: '{{solved}} حلّوا · {{going}} أكّدوا' },
