export const studioCopy = {
  en: {
    ...
    delivery: { title: 'Choose how the puzzle arrives.', body: 'JIGZO sends every invitation. Each guest is reached the way you listed them.', readyLabel: 'invitations ready to go out', readyLabelSingular: 'invitation ready to go out', email: 'Email', emailStatus: 'Sending now', emailIdleStatus: 'Not sending yet', emailCaption: 'guests reached by email', emailCaptionSingular: 'guest reached by email', whatsapp: 'WhatsApp', whatsappCaption: 'guests waiting on WhatsApp', whatsappCaptionSingular: 'guest waiting on WhatsApp', whatsappCaptionMoved: 'moved to email', whatsappPillBlocked: 'Not available yet', whatsappPillMoved: 'Moved to email', blockedTitle: 'guests can’t be reached on WhatsApp yet', blockedBody: 'WhatsApp delivery is waiting on approval from Meta for our business template. Everything else about this campaign is ready. Fix these guests in Recipients, or leave them and send the rest.', seeWho: 'See who they are', fixInRecipients: 'Fix in Recipients', previewTitle: 'Preview as guest', previewBody: 'Opens the real envelope-to-invitation experience in a new tab, exactly as a guest sees it. It never counts as a recipient or touches your results.', previewNamePlaceholder: 'Guest name for the preview (optional)', previewButton: 'Preview as guest', previewFailed: 'Preview failed.', testTitle: 'Send yourself a copy', testBody: 'A real invitation with a real puzzle, addressed to you. It does not touch anyone’s results.', testPlaceholder: 'you@company.com', testButton: 'Send test',
