...
export const businessApi = {
  ...
  ,persistPuzzle: async (campaignId, cropData) => (await client.post(`/campaigns/${encodeURIComponent(campaignId)}/puzzle`, { cropData }, { headers: { 'X-JIGZO-CSRF': csrfToken }, timeout: 45000 })).data.puzzle
